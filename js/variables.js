...
const questions = [
  ...
  {
    topic: 'work out how many pizza slices there will be',
    variable1: 'pizzas',
    variable2: 'slices_per_pizza',
    variable3: 'total_slices',
    question1: 'How many pizzas are you ordering?',
    question2: 'How many slices are in a pizza?',
    answer1: '3',
    answer2: '8',
    calculation: '{variable1}  * {variable2}',
    result: 24,
    response: '"There will be a total of", {result}, "slices."',
    responsePlus: '"There will be a total of " + str({result}) + " slices."',
  },
  {
